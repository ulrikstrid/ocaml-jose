  ...
  *)
  module Pub : sig
    ...
    *)
    ...
    val rsa_of_pub : Nocrypto.Rsa.pub -> (rsa, [ `Msg of string ]) result
    (**
    [rsa_of_pub pub] takes a public key generated by Nocrypto and returns a result t or a message of what went wrong.
    *)

    val rsa_to_pub : rsa -> (Nocrypto.Rsa.pub, [ `Msg of string ]) result
    (**
    [rsa_to_pub t] takes a public JWK and returns a result [Nocrypto.Rsa.pub] or a message of what went wrong.
    *)
  ...
  *)
  module Priv : sig
    ...
    *)
    ...
    val rsa_to_priv : rsa -> (Nocrypto.Rsa.priv, [ `Msg of string ]) result
    (**

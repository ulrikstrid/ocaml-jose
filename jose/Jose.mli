...
(** {1 JSON Web Key} {{: https://tools.ietf.org/html/rfc7517 } Link to RFC } *)
module Jwk : sig
  ...
  (** {1 Public keys} These keys are safe to show and should be used to verify
      signed content. *)
  ...
  (** {1 Utils } Utils to get different data from a JWK *)
